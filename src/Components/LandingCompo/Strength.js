        ...
        <div className="gradient-cards">
          <div className="card">
            <div className="container-card bg-green-box">
              ...
              <p className="card-title">Zero-cost Building</p>
              <p className="card-description">
                Transparent pricing , No hidden fees , absolutly free of cost.
              </p>
            </div>
          </div>
          <div className="card">
            <div className="container-card bg-white-box">
              ...
              <p className="card-title">Permissionless</p>
              <p className="card-description">
                Anyone can use Dev Mania , without any permission.
              </p>
            </div>
          </div>
          <div className="card">
              ...
              >
                ...
                <defs>
                  <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop stopColor="#FFE34B" stopOpacity="0.7" />
                    <stop
                      offset="0.510417"
                      stopColor="#FFE34B"
                      stopOpacity={0}
                    />
                    <stop offset={1} stopColor="#FFE34B" stopOpacity="0.7" />
                  </linearGradient>
                  <radialGradient
                  ...
                  >
                    ...
                    <stop offset={1} stopColor="#302A1A" stopOpacity="0.2" />
                  </radialGradient>
                </defs>
              </svg> */}
              <p className="card-title">Owned by you</p>
              <p className="card-description">
                Projects built using this application are completely owned by
                you.
              </p>
            </div>
          </div>
              ...
              >
                ...
                <defs>
                  <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop stopColor="#61A0FF" stopOpacity="0.7" />
                    <stop
                      offset="0.489583"
                      stopColor="#61A0FF"
                      stopOpacity={0}
                    />
                    <stop offset={1} stopColor="#61A0FF" stopOpacity="0.7" />
                  </linearGradient>
                  <radialGradient
                    ...
                    gradientTransform="translate(60 60) rotate(96.8574) scale(122.674 149.921)"
                  >
                    <stop stopColor="#87A1FF" />
                    <stop offset={1} stopColor="#16161D" stopOpacity="0.2" />
                  </radialGradient>
                </defs>
              </svg> */}
              <p className="card-title">Easy Collaboration</p>
              <p className="card-description">
                You can directly get connect and collaborate with other
                developers.
              </p>
            </div>
          </div>
